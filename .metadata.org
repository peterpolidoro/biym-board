...
TOP=./documentation/pcb/top.png
if [ -f $TOP ]; then
    echo "[[file:./documentation/pcb/top.png]]\n"
fi
BOTTOM=./documentation/pcb/bottom.png
if [ -f $BOTTOM ]; then
    echo "[[file:./documentation/pcb/bottom.png]]\n"
fi
#+END_SRC
...
#+BEGIN_SRC sh :exports results :results raw
for FILEPATH in ./documentation/schematic/*.pdf; do
    FILENAME=${FILEPATH##*/}
    echo "[[file:./documentation/schematic/$FILENAME][./documentation/schematic/$FILENAME]]\n"
done
#+END_SRC
...
#+BEGIN_SRC sh :exports results :results raw
for FILEPATH in ./documentation/pcb/*.svg; do
    FILENAME=${FILEPATH##*/}
    if [ "$FILENAME" != "*.png" ]
    then
        echo "[[file:./documentation/pcb/$FILENAME]]\n"
    fi
done
#+END_SRC
